<?php include('./includes/header.php') ?> <section class="home">
  <div class="topHeader sticky-top">
    <h2>My Schedule </h2> <?php include('./includes/topHeader.php') ?>
  </div>
  <div class="padd-wrap">
    <div class="container">
      <div class="row">
                ...
                <table class="table table-hover">
                  <thead class="py-5">
                    <tr class="py-5">
                      ...
                      <th class="py-3">Morning</th>
                      <th class="py-3">Evening</th>
                    </tr>
                  </thead>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    var morningSelectCheckboxes = document.querySelectorAll(".morningselect");
    var eveningSelectCheckboxes = document.querySelectorAll(".eveningselect");
