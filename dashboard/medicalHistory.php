                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-8">
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="py-1"><span class="info">Marital Status:</span> <span class="text-black-50">
                                                Married</span></span>
                                        <span class="py-1"><span class="info">Occupation:</span> <span class="text-black-50"> Student</span></span>
                                        <span class="py-1"><span class="info">Address:</span> <span class="text-black-50">
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="rightProfile">
                                    <div class="d-flex flex-column">
                                        <span class="py-1"><span class="info">Gender:</span> <span class="text-black-50">
                                                Male</span></span>
                                        <span class="py-1"><span class="info">Mobile:</span> <span class="text-black-50"> 111-1111-1111</span></span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="medicalDetails">
                        <div class="tab">
                            <button class="tablinks mb-3" onclick="openCity(event, 'personalDetails')" id="defaultOpen"><i class="mx-2 fa fa-user" aria-hidden="true"></i>
                                Personal
                                Details</button>
                            <button class="tablinks mb-3" onclick="openCity(event, 'MedialHistory')"><i class="mx-2 fa fa-stethoscope" aria-hidden="true"></i>
                                Medical
                                History</button>
                            <button class="tablinks mb-3" onclick="openCity(event, 'notes')"><i class="mx-2 fa fa-book" aria-hidden="true"></i>
                                Notes</button>
                            <button class="tablinks mb-3" onclick="openCity(event, 'reports')"><i class="mx-2 fa fa-sticky-note" aria-hidden="true"></i>
                                Reports</button>
                            <button class="tablinks mb-3" onclick="openCity(event, 'medications')"><i class="mx-2 fa fa-medkit" aria-hidden="true"></i>
                            ...
                            <div class="tabs-container">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="tabs">
                                            <li> <button data-tab="tab1" class="tab-link current"> Diagnosis</button>
                                            </li>
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="pt-4">
                                                        <input type="text" class="form-control" id="exampleInput" placeholder="Enter a value" disabled>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <div class="d-flex justify-content-around">
                                                ...
                                                <div class="d-flex">
                                                    <div>
                                                        ...
                                                        <span>Yes</span><input class="form-check-input ms-1" type="radio" value="" />
                                                    </div>
                                                    <div class="px-2">

                                                        <span>No</span><input class="form-check-input ms-1" type="radio" value="" />
                                                    </div>
                                                </div>
                        ...
                        <div id="notes" class="tabcontent">
                            <div class="tabs-container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="tabs">
                                            <li> <button data-tab="encounterNotes" class="tab-link current">Encounter
                                                    Notes</button>
                                            </li>
                                            <li> <button data-tab="soapNotes" class="tab-link">Soap Notes</button></li>
                                        </ul>
                                    </div>
                                </div>
